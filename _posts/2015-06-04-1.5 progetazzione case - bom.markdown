...
Dopo gli sketch e le ipotesi preliminari si è iniziata la progettazione, con relativa ingenierizzazione del case, considerando sempre le tecnologie disponibili all'interno di WeMake.
...
Tutti i pannelli esterni di copertura, ed interni di divisione delle zone funzionali saranno realizzati in [Parapan](http://sadun.it/prodotti/parapan/), un materiale polimerico molto utilizzato in cucina per le sue ottime proprietà antigraffio e di facile pulizia, sfruttando il taglio laser.
...
Di seguito un'immagine del modello digitale della configurazione finale del case, in fondo è riportato il Bill of Materials.
